...
The sample result videos of our algorithm, CLoc, can be found in the `videos` folder. These videos show comparisons between CLoc and a one-shot visual localization (OVL) method by rendering colored point clouds onto the image plane using the estimated poses.
